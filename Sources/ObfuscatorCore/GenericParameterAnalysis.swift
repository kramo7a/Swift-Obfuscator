...
public enum GenericParameterAnalysis {}

extension GenericParameterAnalysis {
    public struct Report: Codable, Equatable, Sendable {
        ...
        public static let empty = GenericParameterAnalysis.Report(
    ...
    /// Compiler-anchored lexical analysis for Swift generic parameters.
    ///
    ...
    public struct Index: Sendable {
        ...
        public let report: GenericParameterAnalysis.Report
        ...
        public init(
            ...
            var candidatesByPathAndOffset: [String: [Int: [SourceToken]]] = [:]
            ...
            self.report = GenericParameterAnalysis.Report(
                ...
                unresolvedGenericParameters: issueReasonsByUSR.count,
